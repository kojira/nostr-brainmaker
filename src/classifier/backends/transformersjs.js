...
// avoid doubling it (e.g. 'model_q4' + dtype 'q4' -> 'model_q4_q4.onnx', which
// does not exist). We return the bare base ('model') and let transformers.js
// re-append '_q4' -> 'model_q4.onnx'.
...
// Documents WHY the q4 ONNX artifact is ~107MB rather than the ~141MB you might
// expect from a "full" 4-bit quantization. The q4 build is a PARTIAL
